...
CREATE TABLE `tb_item_venda` (
  ...
  KEY `ProdutoIdfk_idx` (`ProdutoId`),
  CONSTRAINT `ProdutoIdfk` FOREIGN KEY (`ProdutoId`) REFERENCES `tb_produto` (`ProdutoId`),
  CONSTRAINT `VendaIdfk` FOREIGN KEY (`VendaId`) REFERENCES `tb_compra` (`CompraId`)
